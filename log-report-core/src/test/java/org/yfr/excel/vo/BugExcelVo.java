...
public class BugExcelVo extends ExcelVo {
	private String sType = "B";
	...
	public BugExcelVo (String sSeqNo, String sDate, String sVersion, 
	...
	public BugExcelVo copyOf() {
		BugExcelVo vo = new BugExcelVo();
	...
	public void copyFields(BugExcelVo v) {
		BugExcelVo vo = (BugExcelVo) v;
