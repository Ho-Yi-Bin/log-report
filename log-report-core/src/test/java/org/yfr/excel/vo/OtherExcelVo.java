...
public class OtherExcelVo extends ExcelVo {
	private String sType = "O";
	...
	public OtherExcelVo (String sSeqNo, String sDate, String sVersion, 
	...
	public OtherExcelVo copyOf() {
		OtherExcelVo vo = new OtherExcelVo();
	...
	public void copyFields(OtherExcelVo v) {
		OtherExcelVo vo = (OtherExcelVo) v;
