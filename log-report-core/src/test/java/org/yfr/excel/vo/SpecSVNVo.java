...
public class SpecSVNVo extends SVNVo {
	...
	public SpecSVNVo (String sType, String sId, String sContext, String sHandler) {
		this.sType 		= sType;
		this.sId		= sId;
		this.sContext	= sContext;
		this.sHandler	= sHandler;
	...
	public SpecSVNVo copyOf() {
		SpecSVNVo vo = new SpecSVNVo();
	...
	public void copyFields(SpecSVNVo v) {
		SpecSVNVo vo = (SpecSVNVo) v;
